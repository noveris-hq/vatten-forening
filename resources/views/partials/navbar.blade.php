    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden md:flex items-center gap-1" aria-label="Huvudnavigering">
                <a href="#om-oss"
                    class="px-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
                    Om oss
                </a>
                <a href="#status"
                    class="px-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md">
            ...
            <div class="md:hidden flex items-center gap-2">
                ...
                <button @click="isMenuOpen = !isMenuOpen"
                    class="p-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <nav x-show="isMenuOpen" x-cloak x-transition:enter="transition ease-out duration-200"
            ...
            class="md:hidden py-4 border-t border-gray-200 dark:border-gray-700" aria-label="Mobilnavigering">
            <div class="flex flex-col gap-1">
                <a href="#om-oss" @click="isMenuOpen = false"
                    class="px-4 py-3 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Om oss
                </a>
