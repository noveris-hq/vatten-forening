...
<div class="space-y-6">
    <div class="px-4">
        <h1 class="text-2xl font-bold text-foreground mb-2">Ledningskarta</h1>
        <p class="text-gray-600">Översikt över vattenledningar och avstängare för varje fastighet</p>
    </div>
    <div class="rounded-lg border border-gray-200 bg-white" id="valve-map">
        <div class="flex flex-col space-y-1.5 p-6">
            <h3 class="text-2xl font-semibold leading-none tracking-tight flex items-center gap-2"><svg
                    ...
                    class="lucide lucide-droplets h-5 w-5 text-primary">
                    <path
                ...
                </svg>Vattenledningsnät</h3>
            <p class="text-sm text-gray-600">Blå linje visar huvudledningen. Markörer visar varje
                fastighets avstängare.</p>
        </div>
        <div class="p-6 pt-0">
            <div id="map-container" class="h-[600px] rounded-lg overflow-hidden border border-gray-200 z-10">
            </div>
