    ...
    <main class="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded">
            <p class="text-sm text-blue-800">
                <strong>Nuvarande:</strong> {{ $waterValve->location_description }}
                <br>
                <strong>Tilldelad till:</strong> {{ $waterValve->user->name }}
                <br>
                <small>Koordinater: {{ $waterValve->latitude }}, {{ $waterValve->longitude }}</small>
            </p>
        </div>
        ...
        <form action="{{ route('water-valves.update', $waterValve->id) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <textarea name="location_description" id="location_description" rows="3" required
                    ...
                    placeholder="Beskriv var ventilen är placerad...">{{ old('location_description', $waterValve->location_description) }}</textarea>
