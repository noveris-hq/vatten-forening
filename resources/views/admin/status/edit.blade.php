...
@section('content')
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('status.update') }}" class="bg-white shadow-sm rounded-lg p-6">
                @csrf
                @method('PUT')
                ...
                <fieldset class="space-y-4">
                    ...
                    <label class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-500">Inga kända problem</div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-start space-x-3">
                        <input type="radio" name="status" value="warning"
                            ...
                            class="mt-1 h-5 w-5 text-amber-600 border-gray-300 focus:ring-amber-500">
                        <div>
                            <div class="font-medium">Driftsstörning</div>
                            <div class="text-sm text-gray-500">Pågående problem som påverkar systemet</div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-500">Kritiskt fel - vattnet är avstängt</div>
                        </div>
                    </label>
                </fieldset>
                ...
                <div class="mt-8">
                    ...
                    <textarea name="message" id="message" rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('message', $status->message) }}</textarea>
                    @error('message')
                ...
                <div class="mt-8 flex items-center justify-end gap-4">
                    <a href="{{ route('status.show') }}" class="text-gray-600 hover:text-gray-900">
                        Avbryt
                    </a>
                    <button type="submit"
