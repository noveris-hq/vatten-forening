            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between flex-col">
                    ...
                    <a href="{{ route('nyheter.create') }}"
                        class="bg-blue-900/90 text-white inline-flex mt-5 items-center gap-2 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-900/80 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                ...
                @foreach ($news as $item)
                    <div class="space-y-3">
                        <div class="p-4 bg-silver-50/10 rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if ($item->is_important)
                                            <span
                                                class="inline-flex items-center dark:bg-yellow-400/90 dark:text-yellow-950 px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-400/20 text-yellow-950">
                                                Viktig
                                            </span>
                                        @endif
                                    </div>
                                ...
                                <div class="flex gap-1">
                                    <a href="{{ route('nyheter.edit', $item->id) }}">
                                        <button title="Redigera"
                                            class="dark:text-white hover:cursor-pointer hover:bg-teal-200/30 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-8 w-8">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
