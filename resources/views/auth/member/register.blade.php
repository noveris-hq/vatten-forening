    ...
    <div class="max-w-md w-full">
        <div class="text-center mb-8">
            <div class="flex items-center justify-center gap-2 mb-4">
                ...
                <h1 class="text-2xl font-serif font-bold text-gray-900 dark:text-gray-100">Östra Karbäcken</h1>
            </div>
            <h2 class="text-xl text-gray-600 dark:text-gray-300">Medlemsregistrering</h2>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700">
            <h3 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Skapa konto</h3>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Namn<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                    ...
                    @error('name')
                        <div class="label -mt-4 mb-2">
                            <span class="label-text-alt text-red-600 dark:text-red-400">{{ $message }}</span>
                        </div>
                    @enderror
                ...
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        E-postadress<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="street_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Adress<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="postal_code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Postnummer<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="city" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Ort<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="property_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Fastighetsnummer<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Lösenord<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Bekräfta lösenord<span class="text-red-500 dark:text-red-400">*</span>
                    </label>
